...
<div className="flex relative dark:bg-main-dark-bg">
      {activeMenu ? (
        ...
        <div className="-mt-3 md:m-10 h-8/9 mt-18  p-0 sm:pt-20 md:p-10 bg-white rounded ">
            ...
            <div className='flex-col flex space-y-6 my-10'>
            <span>
            ...
            <a href="/" class="text-white bg-myred  font-medium rounded-lg text-xs px-5 py-2.5 mr-2 mb-2 ">observations</a>
            ...
            <span>
            <a href="/general" class="text-black bg-white hover:bg-myblue hover:text-white font-medium rounded-lg text-xs px-5 py-2.5 mr-2 mb-2 ">anad</a>
            <a href="/enseignants" class="text-black bg-white hover:bg-myblue hover:text-white font-medium rounded-lg text-xs px-5 py-2.5 mr-2 mb-2 ">fds</a>
            <a href="/Infos" class="text-black bg-white hover:bg-myblue hover:text-white font-medium rounded-lg text-xs px-5 py-2.5 mr-2 mb-2 ">bdda</a>
            <a href="/" class="text-black bg-white hover:bg-myblue hover:text-white font-medium rounded-lg text-xs px-5 py-2.5 mr-2 mb-2 ">cprj</a>
            <a href="/divers" class="text-white bg-myred  font-medium rounded-lg text-xs px-5 py-2.5 mr-2 mb-2 ">comp</a>
            <a href="/general" class="text-black bg-white hover:bg-myblue hover:text-white font-medium rounded-lg text-xs px-5 py-2.5 mr-2 mb-2 ">igl</a>
            <a href="/enseignants" class="text-black bg-white hover:bg-myblue hover:text-white font-medium rounded-lg text-xs px-5 py-2.5 mr-2 mb-2 ">ang</a>
            <a href="/Infos" class="text-black bg-white hover:bg-myblue hover:text-white font-medium rounded-lg text-xs px-5 py-2.5 mr-2 mb-2 ">cloud</a>
